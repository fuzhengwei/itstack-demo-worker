...
<table id="dg" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th data-options="field:'cronExDesc',formatter: util.cronExDesc" align="left">
            cronExDesc
        </th>
...
<div id="tb" style="padding:2px 5px;">
    <a class="easyui-linkbutton" iconCls="icon-refresh" onclick="menu.doSearch()">刷新</a>
    <br/>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" plain="true"
       onclick="menu.doStartSchedule();">开启</a>
    |
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-clear" plain="true"
       onclick="menu.doStopSchedule();">关闭</a>
</div>
